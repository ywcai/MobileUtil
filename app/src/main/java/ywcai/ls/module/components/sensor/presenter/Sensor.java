package ywcai.ls.module.components.sensor.presenter;
...
import ywcai.ls.module.components.gps.UpdateViewInf;
import ywcai.ls.module.components.sensor.model.SensorInfo;
...
public class Sensor implements UpdateViewInf , SensorEventListener {
    ...
    public Sensor(View view,Context pContext) {
        context=pContext;
        tabView = view;
        listener=this;
