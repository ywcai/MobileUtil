...
public class WifiAdapter extends BaseAdapter{
    ...
    public View getView(int position, View convertView, ViewGroup parent) {
        ...
        if (convertView == null) {
            ...
            vh = new ViewTempWifi();
            vh.tv_sid = (TextView) convertView.findViewById(R.id.device_name);
            ...
            vh.tv_keyType=(TextView)convertView.findViewById(R.id.device_id);
            vh.tv_mac=(TextView)convertView.findViewById(R.id.tv_mac);
            vh.pb_Dbm=(LsPercentBar)convertView.findViewById(R.id.pb_Dbm);
