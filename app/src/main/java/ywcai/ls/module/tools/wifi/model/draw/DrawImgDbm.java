...
public class DrawImgDbm {
    ...
    public void saveLog() {
        ...
        String fileName = timeUtil.getDetailTime();
        String fileDirPath = fileSaveUtil.getImgDirPath(MyConfig.STR_INTENT_LOG_PATH_DBM);
        if (!(fileSaveUtil.saveLogImg(dbmLog, fileDirPath, fileName + ".jpg")).equals("success")) {
    ...
    private void drawLogo(int chanel) {
        ...
        TimeUtil timeUtil=new TimeUtil();
        String makeTime = timeUtil.getDetailTime();
