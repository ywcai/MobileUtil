...
import ywcai.ls.module.tools.wifi.model.draw.DrawImgDbm;
import ywcai.ls.module.tools.wifi.presenter.inf.WifiDbmBgClearInf;
import ywcai.ls.mobileutil.R;
import ywcai.ls.common.image.container.ImageActivity;
import ywcai.ls.module.tools.wifi.view.WifiDbmRecordFragment;
...
public class RefreshWifiDbm implements WifiDbmBgClearInf {
    ...
    private void showDbmRecord() {
        ...
        List<File> imgList = fileLookUtil.getImgList(MyConfig.STR_INTENT_LOG_PATH_DBM);
        int h;
        if (imgList == null) {
            h = 240;
